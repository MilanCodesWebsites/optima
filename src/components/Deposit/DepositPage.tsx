...
const DepositPage: React.FC<DepositPageProps> = ({ onDeposit }) => {
  ...
  const handleConfirmDeposit = () => {
    const transaction = {
      type: 'credit' as const, // Map 'deposit' to 'credit'
      amount,
      description: `Deposit ${amount} ${selectedCurrency}`, // Add description field
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-slate-400">Add funds to your Optima account</p>
      </div>
