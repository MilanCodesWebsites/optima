...
const VerificationInfoCard: React.FC = () => {
  ...
  return (
    <>
      <div className="bg-gradient-to-br from-blue-500/10 to-purple-500/10 border border-blue-500/30 rounded-2xl p-4 sm:p-6 mb-6 animate-fade-in">
        <div className="flex items-start gap-3 sm:gap-4">
          ...
          <div className="flex-1">
            <div className="flex items-start justify-between gap-3 sm:gap-4">
              <div>
                <h3 className="text-base sm:text-lg font-semibold text-white mb-2 flex items-center gap-2 flex-wrap">
